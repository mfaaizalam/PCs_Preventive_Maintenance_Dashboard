...
def upgrade() -> None:
    ...
    # USERS
    # ============================================================
    # Matches current app/models/user.py
    #
    # username
    # hashed_password
    # role
    ...
    op.create_index(
        op.f("ix_maintenance_assets_asset_id"),
        "maintenance_assets",
        ["asset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_maintenance_assets_lab_section"),
        "maintenance_assets",
        ["lab_section"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_maintenance_assets_pc_no"),
        "maintenance_assets",
        ["pc_no"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "computer_id",
            "slot_number",
            name="uq_ram_slots_computer_slot",
        ),
    )

    op.create_index(
        op.f("ix_ram_slots_computer_id"),
        "ram_slots",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_storage_devices_computer_id"),
        "storage_devices",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_peripherals_computer_id"),
        "peripherals",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_software_licenses_computer_id"),
        "software_licenses",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_installed_software_computer_id"),
        "installed_software",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_metrics_history_computer_id"),
        "metrics_history",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_hardware_change_log_changed_at"),
        "hardware_change_log",
        ["changed_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_hardware_change_log_computer_id"),
        "hardware_change_log",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_hardware_change_log_id"),
        "hardware_change_log",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_maintenance_log_completed_at"),
        "maintenance_log",
        ["completed_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_maintenance_log_maintenance_asset_id"),
        "maintenance_log",
        ["maintenance_asset_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_maintenance_log_maintenance_task_id"),
        "maintenance_log",
        ["maintenance_task_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_peripheral_events_computer_id"),
        "peripheral_events",
        ["computer_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_peripheral_events_occurred_at"),
        "peripheral_events",
        ["occurred_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_peripheral_events_peripheral_id"),
        "peripheral_events",
        ["peripheral_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_hardware_change_log_id"),
        table_name="hardware_change_log",
    )
